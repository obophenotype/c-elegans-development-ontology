These notes are for the EDITORS of wbls
...
Make sure you have an ID range in the [idranges file](wbls-idranges.owl)

If you do not have one, get one from the maintainer of this repo.

The editors version is [wbls-edit.owl](wbls-edit.owl)

** DO NOT EDIT wbls.obo OR wbls.owl in the top level directory **

[../../wbls.owl](../../wbls.owl) is the release version

To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/obophenotype/c-elegans-development-ontology) for details.
 ...
 * [wbls-idranges.owl](wbls-idranges.owl)
...
There are two ways to include new classes in an import module
 ...
 2. Add to the imports/wbls_terms.txt file
...
Note: the wbls_terms.txt file may include 'starter' classes seeded from
...
This generates derived files such as wbls.owl and wbls.obo and places
 ...
 * https://github.com/obophenotype/c-elegans-development-ontology/releases
 * https://github.com/obophenotype/c-elegans-development-ontology/releases/new
...
what is in the `owl:versionIRI` of the derived wbls.owl (`data-version` in
wbls.obo). This will be today's date.
 ...
 * http://purl.obolibrary.org/obo/wbls.owl <-- current ontology PURL
 * http://purl.obolibrary.org/obo/wbls/releases/YYYY-MM-DD.owl <-- change to the release you just made

For questions on this contact Chris Mungall or email obo-admin AT obofoundry.org

# Travis Continuous Integration System

Check the build status here: [![Build Status](https://travis-ci.org/obophenotype/c-elegans-development-ontology.svg?branch=master)](https://travis-ci.org/obophenotype/c-elegans-development-ontology)

Note: if you have only just created this project you will need to authorize travis for this repo.

 1. Go to [https://travis-ci.org/profile/obophenotype](https://travis-ci.org/profile/obophenotype)
 2. click the "Sync account" button
 3. Click the tick symbol next to c-elegans-development-ontology
