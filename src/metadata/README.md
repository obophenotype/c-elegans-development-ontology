 ...
 * [wbls.yml](wbls.yml)
     * Determines how your purl.obolibrary.org/obo/wbls/ redirects will be handled
     ...
     * Paste in the contents of [wbls.yml](wbls.yml)
 ...
 * [wbls.md](wbls.md)
     ...
     * Paste in the contents of [wbls.md](wbls.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
